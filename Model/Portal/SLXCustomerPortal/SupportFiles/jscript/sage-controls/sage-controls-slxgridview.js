	...
	if (this.HeaderRow) {
		for(var r = 0; r < this.table.rows.length; r++) {
			if (this.table.rows[r].cells[colIdx]) {
			    /*
				if ((this.table.rows[r].cells[colIdx].childNodes[0]) && (this.table.rows[r].cells[colIdx].childNodes[0].nodeType != 3)
				        && (this.table.rows[r].cells[colIdx].childNodes[0].getAttribute("setwidth"))) {
					//this.table.rows[r].cells[colIdx].childNodes[0].style.width = width;
					YAHOO.util.Dom.setStyle(this.table.rows[r].cells[colIdx].childNodes[0], "width", width);
				}
				*/
