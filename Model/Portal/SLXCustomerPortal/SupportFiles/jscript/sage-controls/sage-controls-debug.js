...
function RestrictToCurrency(e) {
    var code = e.charCode || e.keyCode;
    return (code == this.Symbol.charCodeAt(0) || RestrictToNumeric(e, this.GroupSeparator.charCodeAt(0), this.DecimalSeparator.charCodeAt(0)));
}
...
Sage.SalesLogix.Controls.BufferedGridView = Ext.extend(Ext.ux.grid.BufferedGridView, {
    ...
    adjustVisibleRows: function() {
        ...
        if (rows[0]) {
            var rh = rows[0].offsetHeight + 0.5; 
            if (rh < 1.0) {
                this.rowHeight = -1;
                return;
            }
...
function LookupControl(options) {
    ...
    for (var i = 0; i < this._properties.length; i++)
    {
        ...
        if (this._properties[i].useAsResult) this._returnProperty = this._properties[i].name;
    }
...
LookupControl.prototype.createDialog = function() {
    ...
    var dialog = new Ext.Window({
        ...
        title: String.format(LookupControlResources.LookupControl_Header, this._entityDisplayName),
        cls: "lookup-dialog",
        layout: "border",            
        closeAction: "hide",
        plain: true,
