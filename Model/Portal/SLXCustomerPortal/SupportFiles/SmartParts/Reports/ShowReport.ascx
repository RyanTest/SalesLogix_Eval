<%@ Control language="c#" Inherits="Sage.SalesLogix.Client.Reports.Helper.ShowReport" %>
<%@ Register Assembly="Sage.SalesLogix.Web.Controls" Namespace="Sage.SalesLogix.Web.Controls" TagPrefix="SalesLogix" %>

<div style="display:none">
<asp:Panel ID="ShowReport_LTools" runat="server">
</asp:Panel>
<asp:Panel ID="ShowReport_CTools" runat="server">
</asp:Panel>
<asp:Panel ID="ShowReport_RTools" runat="server">
