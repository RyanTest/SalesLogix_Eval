...
function UserPanel_Show()
{
    if (this.CanShow())
    {
        if ((this.panel == null) || (this.panel.element.parentNode == null))
        {
            ...
            this.panel = new YAHOO.widget.Panel(this.UserDivId, { visible:false, width:"305px", /*x:250, y:200,*/ fixedcenter:true, constraintoviewport:true, underlay:"shadow", draggable:true, modal:false });
            this.panel.render();
        }
        this.panel.show();
