...
Function sp_MergeFromFile(aFileName)
    ...
    End If
  	...
  	Result = False
  	Set oMME = CreateObject("SLXMMEngineW.MailMergeEngine")
...
Function sp_BuildMailMergeFile(ByVal vXML, ByVal vFileName, ByVal contactId, ByVal authorId, ByVal leaderId)
    ...
    End If
    set objFS = Nothing
    set objSLXDOC = CreateObject("SLXDocW.SLXDocument")
...
Function sp_PopEmailAddress(aContactID)
    ...
    Set oSelectNames = CreateObject("SLXMMGUIW.SelectEmailNames")
...
Function sp_GetFilePath()
    ...
    If strSelection = "" Then
        strSelection = top.GM.GetPersonalDataPath
    End If
    set oSLXMMGUI = CreateObject("SLXMMGUIW.MailMergeGUI")
