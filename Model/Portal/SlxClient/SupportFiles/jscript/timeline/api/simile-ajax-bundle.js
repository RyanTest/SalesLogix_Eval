...
/* history.js */
SimileAjax.History={maxHistoryLength:10,historyFile:SimileAjax.urlPrefix+"history.html",enabled:true,_initialized:false,_listeners:new SimileAjax.ListenerQueue(),_actions:[],_baseIndex:0,_currentIndex:0,_plainDocumentTitle:document.title};
