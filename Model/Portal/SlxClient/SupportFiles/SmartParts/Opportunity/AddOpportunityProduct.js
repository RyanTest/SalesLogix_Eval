Type.registerNamespace("SmartParts.Opportunity");

SmartParts.Opportunity.AddOpportunityProduct = function(options) {
    this._options = options;
};

SmartParts.Opportunity.AddOpportunityProduct.create = function(id, options) {
window[id] = new SmartParts.Opportunity.AddOpportunityProduct(options);
    window[id].init();
};

SmartParts.Opportunity.AddOpportunityProduct.prototype.init = function() {
    this.initProductsTreePanel();
};

SmartParts.Opportunity.AddOpportunityProduct.prototype.initProductsTreePanel = function() {
    var self = this;
...
SmartParts.Opportunity.AddOpportunityProduct.prototype.processSelectedNodes = function() {
