<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectContactId.aspx.cs" Inherits="SelectContactId" %>
...
<body onunload="unload()">
    ...
    <div id="MainWorkArea" class="formtable">
        <div style="visibility:hidden;">
            <SalesLogix:LookupControl runat="server" ID="SelectedContact" LookupEntityName="Contact" LookupEntityTypeName="Sage.SalesLogix.Entities.Contact, Sage.SalesLogix.Entities">
                <LookupProperties>
                    <SalesLogix:LookupProperty PropertyHeader="<%$ resources: luSelectedContact_Account %>" PropertyName="AccountName" PropertyFormat="None"  UseAsResult="False"></SalesLogix:LookupProperty>
                    <SalesLogix:LookupProperty PropertyHeader="<%$ resources: luSelectedContact_LastName %>" PropertyName="LastName" PropertyFormat="None"  UseAsResult="False"></SalesLogix:LookupProperty>
                    <SalesLogix:LookupProperty PropertyHeader="<%$ resources: luSelectedContact_FirstName %>" PropertyName="FirstName" PropertyFormat="None"  UseAsResult="False"></SalesLogix:LookupProperty>
                    <SalesLogix:LookupProperty PropertyHeader="<%$ resources: luSelectedContact_Work %>"  PropertyName="WorkPhone" PropertyFormat="None"  UseAsResult="False"></SalesLogix:LookupProperty>
                    <SalesLogix:LookupProperty PropertyHeader="<%$ resources: luSelectedContact_Mobile %>"  PropertyName="Mobile" PropertyFormat="None"  UseAsResult="False"></SalesLogix:LookupProperty>
                    <SalesLogix:LookupProperty PropertyHeader="<%$ resources: luSelectedContact_Email %>"  PropertyName="Email" PropertyFormat="None"  UseAsResult="False"></SalesLogix:LookupProperty>
                </LookupProperties>
                <LookupPreFilters>
                </LookupPreFilters>
    ...
    <script type="text/javascript">
        function unload() {
            if (document.getElementById('SelectedContact_LookupResult') != null) {
                returnValue = document.getElementById('SelectedContact_LookupResult').value;
            } else {
                returnValue = document.getElementById('SelectedOppContact_LookupResult').value;
            }
        }
        $("document").ready(function() {
            var oGrid;
            var oNativeGrid;
            if (typeof SelectedOppContact != 'undefined') {
                SelectedOppContact_luobj.show();
                oGrid = SelectedOppContact_luobj.getGrid();
                if (oGrid != null) {
            ...
            if (typeof SelectedContact != 'undefined') {
                SelectedContact_luobj.show();
                oGrid = SelectedContact_luobj.getGrid();
                if (oGrid != null) {
                    oNativeGrid = oGrid.getNativeGrid();
                    if (oNativeGrid != null) {
                        oNativeGrid.on('rowdblclick', function(nativeGrid, rowIndex, e) { window.close(); });
